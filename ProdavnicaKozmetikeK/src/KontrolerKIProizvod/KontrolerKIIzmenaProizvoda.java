...
public class KontrolerKIIzmenaProizvoda {
     public static void izmenaProizvoda(JTextField jtxtProizvodID, JTextField jtxtNaziv, JTextField jtxtCena, JDateChooser jtxtRokVazenja, JComboBox jcbVrsteProizvoda) {
        ...
        try {
            ...
            p.setNaziv(naziv);
            p.setCena(cena);
            p.setRokVazenja(rokVazenja);
            p.setVrstaProizvoda(vrstaProizvoda);

            Sesija.dajObjekat().izmeniProizvod(p);
